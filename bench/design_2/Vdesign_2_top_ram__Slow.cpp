...
VL_CTOR_IMP(Vdesign_2_top_ram) {
    VL_CELL(dp_ram_i, Vdesign_2_top_dp_ram);
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vdesign_2_top_ram::__Vconfigure(Vdesign_2_top__Syms* vlSymsp, bool first) {
...
void Vdesign_2_top_ram::_settle__TOP__design_2_top__forte_soc_top_i__ram_0__1(Vdesign_2_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign_2_top_ram::_settle__TOP__design_2_top__forte_soc_top_i__ram_0__1\n"); );
...
void Vdesign_2_top_ram::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign_2_top_ram::_ctor_var_reset\n"); );
    // Body
    __PVT__clk = VL_RAND_RESET_I(1);
    __PVT__instr_req_i = VL_RAND_RESET_I(1);
    __PVT__instr_addr_i = VL_RAND_RESET_I(12);
    __PVT__instr_rdata_o = VL_RAND_RESET_I(32);
    __PVT__instr_rvalid_o = VL_RAND_RESET_I(1);
    __PVT__instr_gnt_o = VL_RAND_RESET_I(1);
    __PVT__ibex_data_req_i = VL_RAND_RESET_I(1);
    __PVT__ibex_data_addr_i = VL_RAND_RESET_I(12);
    __PVT__ibex_data_we_i = VL_RAND_RESET_I(1);
    __PVT__ibex_data_be_i = VL_RAND_RESET_I(4);
    __PVT__ibex_data_wdata_i = VL_RAND_RESET_I(32);
    __PVT__ibex_data_rdata_o = VL_RAND_RESET_I(32);
    __PVT__ibex_data_rvalid_o = VL_RAND_RESET_I(1);
    __PVT__ibex_data_gnt_o = VL_RAND_RESET_I(1);
    __PVT__uart_data_req_i = VL_RAND_RESET_I(1);
    __PVT__uart_data_addr_i = VL_RAND_RESET_I(12);
    __PVT__uart_data_we_i = VL_RAND_RESET_I(1);
    __PVT__uart_data_be_i = VL_RAND_RESET_I(4);
    __PVT__uart_data_wdata_i = VL_RAND_RESET_I(32);
    __PVT__uart_data_rdata_o = VL_RAND_RESET_I(32);
    __PVT__uart_data_rvalid_o = VL_RAND_RESET_I(1);
    __PVT__uart_data_gnt_o = VL_RAND_RESET_I(1);
    __PVT__data_req_i = VL_RAND_RESET_I(1);
    __PVT__data_addr_i = VL_RAND_RESET_I(12);
